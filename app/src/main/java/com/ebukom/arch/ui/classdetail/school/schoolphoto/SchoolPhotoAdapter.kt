...
class SchoolPhotoAdapter (
    ...
    class SchoolPhotoViewHolderRed (itemView: View, val callback: OnMoreCallback) : RecyclerView.ViewHolder(itemView) {
    ...
    class SchoolPhotoViewHolderBlue (itemView: View, val callback: OnMoreCallback) : RecyclerView.ViewHolder(itemView) {
        fun bind (dataModel: ClassDetailPhotoDao) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == TYPE_RED) {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_photo_red, parent, false)
            return SchoolPhotoViewHolderRed(view, callback)
        } else {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_photo_blue, parent, false)
