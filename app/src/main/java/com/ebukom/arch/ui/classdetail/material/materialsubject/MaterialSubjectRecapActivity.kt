...
import kotlinx.android.synthetic.main.activity_material_subject_add.etMaterialSubjectAddTitle
        ...
        when (material) {
            "0" -> {
                ...
                btnMaterialSubjectRecapDone.setOnClickListener {
                    val subjectName = etMaterialSubjectAddTitle.text.toString()
        ...
        when (page) {
            "edit" -> {
                ...
                ivMaterialSubjectDelete.setOnClickListener {
                    val builder = AlertDialog.Builder(this@MaterialSubjectRecapActivity)
                ...
                etMaterialSubjectAddTitle.setText(data.title)
                tvMaterialSubjectFilePath.text = data.content
                btnMaterialSubjectRecapDone.setEnabled(true)
    ...
    private val textWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
            if (etMaterialSubjectAddTitle.text.toString().isNotEmpty()) {
                ...
                btnMaterialSubjectRecapDone.setEnabled(false)
                btnMaterialSubjectRecapDone.setBackgroundColor(
